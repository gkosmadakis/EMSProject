...
<h3> Assign Regulations Page </h3>

<div class="right"> <a href="/EmployeeManagementSystemApp/headDeptHomePage.jsp"> Home</a></div>

<form method=get action="/EmployeeManagementSystemApp/AssignRegulationController">
...
for (int i=0; i<list.size(); i++) { 
	...
	<tr><td style="border: 1px solid #000000;padding:5px;">Creation Date</td>
		<td style="border: 1px solid #000000;padding:5px;"><%=list.get(i).getCreateDate()%></td>
	</tr>
	...
	<tr>	
		<td style="border: 1px solid #000000;padding:5px;"><a href="/EmployeeManagementSystemApp/AssignRegulationController?id=<%=list.get(i).getRegulationId()%>">Assign </a>
		</td>
	</tr> 
